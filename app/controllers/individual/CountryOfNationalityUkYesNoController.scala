...
import pages.individual.CountryOfNationalityUkYesNoPage
...
class CountryOfNationalityUkYesNoController @Inject() (
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("otherIndividual.countryOfNationalityUkYesNo")
