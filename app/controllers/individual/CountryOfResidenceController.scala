...
import pages.individual.CountryOfResidencePage
...
import views.html.individual.CountryOfResidenceView
...
class CountryOfResidenceController @Inject() (
  ...
  private val form: Form[String] = formProvider.withPrefix("otherIndividual.countryOfResidence")
